...
public class NoConcurrencyControlTest {
    ...
    @Test
    @DisplayName("[동시성 제어 없음] 100명 동시 요청")
    void test100Threads() throws InterruptedException {
        runTest(100);
    }

    @Test
    @DisplayName("[동시성 제어 없음] 1000명 동시 요청")
    ...
    private void runTest(int threadCount) throws InterruptedException {
            ...
            executorService.submit(() -> {
                try {
                    applicationService.createApplication(
                            new ApplicationRequestDto.CreateRequestDto(savePostId), applicantId);
        ...
        System.out.println("최종 참가자 수 (정합성): " + post.getCurrentParticipants() + " / 4  ← 불일치 가능");
        System.out.println("=====================================================\n");
