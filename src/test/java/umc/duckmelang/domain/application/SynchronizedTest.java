...
import umc.duckmelang.domain.application.facade.SynchronizedApplicationFacade;
...
public class SynchronizedTest {
    ...
    @Autowired private SynchronizedApplicationFacade synchronizedFacade;
    ...
    @Test
    @DisplayName("[synchronized] 100명 동시 요청")
    void test100Threads() throws InterruptedException {
        runTest(100);
    }

    @Test
    @DisplayName("[synchronized] 1000명 동시 요청")
    ...
    private void runTest(int threadCount) throws InterruptedException {
        ...
        for (int i = 0; i < threadCount; i++) {
            ...
            executorService.submit(() -> {
                try {
                    synchronizedFacade.createApplication(
        ...
        System.out.println("\n========= [synchronized] " + threadCount + "명 실험 결과 =========");
