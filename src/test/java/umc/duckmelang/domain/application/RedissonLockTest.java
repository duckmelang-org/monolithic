...
public class RedissonLockTest {
    ...
    @Autowired private RedissonLockApplicationFacade redissonLockFacade;
    ...
    @Test
    @DisplayName("[Redisson RLock] 100명 동시 요청")
    void test100Threads() throws InterruptedException {
        runTest(100);
    }

    @Test
    @DisplayName("[Redisson RLock] 1000명 동시 요청")
    ...
    private void runTest(int threadCount) throws InterruptedException {
        ...
        // successCount: 신청 성공 (4건이어야 정합)
        // failCount   : 비즈니스 예외(POST_FULL) + 락 획득 타임아웃
        ...
        System.out.println("\n=======================================================");
        System.out.println("========= [Redisson RLock] " + threadCount + "명 실험 결과 =========");
        ...
        System.out.println("실패 건수 (비즈니스+타임아웃): " + failCount.get() + "건");
